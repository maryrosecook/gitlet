...
describe('write-tree', function() {
  ...
  it('should be able to write largish tree when no trees written yet', function() {
    ...
    testUtil.expectFile(".gimlet/objects/380b9be6",
                        "tree 1c778a9 2\nblob 5ceba65 filea\nblob 5ceba66 fileb\n");
    testUtil.expectFile(".gimlet/objects/1c778a9", "tree 51125fde 3\nblob 5ceba67 filec\n");
    testUtil.expectFile(".gimlet/objects/51125fde", "blob 5ceba68 filed\nblob 5ceba69 filee\n");
  });
  ...
  it('should keep blobs written by git add', function() {
    ...
    testUtil.expectFile(".gimlet/objects/5ceba66", "fileb");
    testUtil.expectFile(".gimlet/objects/5ceba67", "filec");
    testUtil.expectFile(".gimlet/objects/5ceba68", "filed");
    testUtil.expectFile(".gimlet/objects/5ceba69", "filee");
  });
  ...
  it('should compose tree from new and existing trees and blobs', function() {
    ...
    testUtil.expectFile(".gimlet/objects/9c02fdc",
                        "tree " + _3aHash + " 3a\ntree " + _3bHash + " 3b\n");
    testUtil.expectFile(".gimlet/objects/" + _3bHash, "blob 5ceba6a filef\nblob 5ceba6b fileg\n");
